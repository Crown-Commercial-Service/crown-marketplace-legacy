Feature: Management Consultancy - Admin - Supplier lot data - Lot 9 - Lot status
  ...
  Scenario: Lot status
    ...
    And I should see the following details in the summary for the lot 'Lot 9 - Environmental Sustainability and Socio-economic Development':
      ...
      | Rates      | View rates    |
    And I click on 'Change Lot status (Lot 9 - Environmental Sustainability and Socio-economic Development)'
