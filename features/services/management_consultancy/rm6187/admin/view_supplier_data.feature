Feature: Management Consultancy - Admin - View supplier data pages
  ...
  Scenario Outline: Supplier details page
    ...
    Examples:
      ...
      | ROMAGUERA INC                 | 587892530   | Yes | Astrid Hickle DC | romaguera.inc@feeney.biz                       | 13210717291         | http://schimmel-yundt.name/jan.heller | 170 Carmelo Meadow, New Susieside, UT 28036       |
