class RemoveOldFrameworkModels < ActiveRecord::Migration[8.0]
  ...
  def change
    ...
    drop_table 'management_consultancy_rm6187_admin_uploads', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
