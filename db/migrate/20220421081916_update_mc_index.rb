class UpdateMcIndex < ActiveRecord::Migration[6.0]
  INDEXES = [
    ...
    %i[management_consultancy_service_offerings index_service_on_lot_number_and_mc_supplier_id index_rm6187_service_on_lot_number_and_mc_supplier_id service_code],
  ].freeze
