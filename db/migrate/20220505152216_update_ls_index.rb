class UpdateLsIndex < ActiveRecord::Migration[6.0]
  INDEXES = [
    ...
    %i[legal_services_regional_availabilities index_service_on_region_and_ls_supplier_id index_service_on_region_and_ls_rm3788_supplier_id service_code region_code legal_services_supplier_id],
    ...
    %i[legal_services_service_offerings index_service_on_lot_number_and_ls_supplier_id index_service_on_lot_number_and_ls_rm3788_supplier_id service_code lot_number legal_services_supplier_id],
