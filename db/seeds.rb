...
holborn = SupplyTeachers::RM3826::Supplier.create!(name: 'Holborn')
...
westminster = SupplyTeachers::RM3826::Supplier.create!(name: 'Westminster')
...
liverpool = SupplyTeachers::RM3826::Supplier.create!(name: 'Liverpool')
