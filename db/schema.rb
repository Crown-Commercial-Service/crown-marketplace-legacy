...
ActiveRecord::Schema.define(version: 2022_05_06_084059) do
  ...
  create_table "legal_services_rm3788_regional_availabilities", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["service_code", "region_code", "legal_services_rm3788_supplier_id"], name: "index_service_on_region_and_ls_supplier_id", unique: true
  end
  ...
  create_table "legal_services_rm3788_service_offerings", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["service_code", "lot_number", "legal_services_rm3788_supplier_id"], name: "index_service_on_lot_number_and_ls_supplier_id", unique: true
  end
