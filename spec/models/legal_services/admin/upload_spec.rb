...
RSpec.describe LegalServices::Admin::Upload, type: :model do
  let(:upload) { create(:legal_services_admin_upload) }
    ...
    context 'when considering if the files are attached' do
      context 'and no files are attached' do
        it 'is not valid and has the correct error messages' do
          ...
          expect(upload.errors.messages.values.flatten).to match ["Select the 'Supplier details' file", "Select the 'Supplier rate cards' file", "Select the 'Supplier lot 1 service offerings' file", "Select the 'Supplier lot 2 service offerings' file", "Select the 'Supplier lot 3 service offerings' file", "Select the 'Supplier lot 4 service offerings' file"]
        end
      end
      ...
      context 'and three files are attached' do
        ...
        it 'is not valid and has the correct error messages' do
          expect(upload.valid?(:upload)).to be false
          expect(upload.errors.messages.values.flatten).to match ["Select the 'Supplier details' file", "Select the 'Supplier lot 2 service offerings' file", "Select the 'Supplier lot 4 service offerings' file"]
        end
      end
    end
    ...
    context 'when considering the file extension' do
      context 'and no files have the correct file extension' do
        before do
          ...
          upload.supplier_lot_4_service_offerings_file = text_file_path
        end

        it 'is not valid and has the correct error messages' do
          expect(upload.valid?(:upload)).to be false
          expect(upload.errors.messages.values.flatten).to match ["The 'Supplier details' file must be an XLSX", "The 'Supplier rate cards' file must be an XLSX", "The 'Supplier lot 1 service offerings' file must be an XLSX", "The 'Supplier lot 2 service offerings' file must be an XLSX", "The 'Supplier lot 3 service offerings' file must be an XLSX", "The 'Supplier lot 4 service offerings' file must be an XLSX"]
        end
      end
      ...
      context 'and three files have the correct file extension' do
        before do
          ...
          upload.supplier_lot_3_service_offerings_file = text_file_path
          upload.supplier_lot_4_service_offerings_file = valid_file_path
        end
    ...
    context 'when considering the file content type' do
      context 'and no files have the correct content type' do
        before do
          ...
          upload.supplier_lot_4_service_offerings_file = invalid_file_path
        end

        it 'is not valid and has the correct error messages' do
          expect(upload.valid?(:upload)).to be false
          expect(upload.errors.messages.values.flatten).to match ["The 'Supplier details' file does not contain the expected content type", "The 'Supplier rate cards' file does not contain the expected content type", "The 'Supplier lot 1 service offerings' file does not contain the expected content type", "The 'Supplier lot 2 service offerings' file does not contain the expected content type", "The 'Supplier lot 3 service offerings' file does not contain the expected content type", "The 'Supplier lot 4 service offerings' file does not contain the expected content type"]
        end
      end
      ...
      context 'and three files have the correct content type' do
        ...
        it 'is not valid and has the correct error messages' do
          expect(upload.valid?(:upload)).to be false
          expect(upload.errors.messages.values.flatten).to match ["The 'Supplier rate cards' file does not contain the expected content type", "The 'Supplier lot 2 service offerings' file does not contain the expected content type", "The 'Supplier lot 4 service offerings' file does not contain the expected content type"]
        end
      end
    end
  ...
  describe 'aasm_state' do
    ...
    context 'when start_upload is called' do
      before do
        allow(LegalServices::FileUploadWorker).to receive(:perform_async).with(upload.id).and_return(true)
        upload.start_upload!
      end
      ...
      it 'starts the worker' do
        expect(LegalServices::FileUploadWorker).to have_received(:perform_async).with(upload.id)
      end
    end
