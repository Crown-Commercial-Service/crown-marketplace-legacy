...
RSpec.describe LegalServices::RM3788::Journey::CheckSuitability, type: :model do
  ...
  describe 'validations' do
    context 'when no service_suitable is provided' do
      ...
      it 'is not valid and has the correct error message' do
        ...
        expect(step.errors[:service_suitable].first).to eq 'Select yes if the fees will be under £20,000'
      end
    end
  ...
  describe '.next_step_class' do
    ...
    context 'and the service_suitable is no' do
      ...
      it 'returns Journey::Sorry' do
        expect(step.next_step_class).to be LegalServices::RM3788::Journey::Sorry
      end
    end
  end
