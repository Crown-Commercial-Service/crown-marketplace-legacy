...
RSpec.describe LegalServices::RM3788::Journey::SelectLot, type: :model do
  ...
  describe '.next_step_class' do
    ...
    context 'and the lot_number is 2' do
      ...
      it 'returns Journey::ChooseJurisdiction' do
        expect(step.next_step_class).to be LegalServices::RM3788::Journey::ChooseJurisdiction
      end
    end
    ...
    context 'and the lot_number is 4' do
      let(:lot_number) { '4' }
