...
RSpec.describe LegalServices::RM3788::Journey::ChooseOrganisationType, type: :model do
  ...
  describe '.next_step_class' do
    context 'and the central government is yes' do
      ...
      it 'returns Journey::CheckSuitability' do
        expect(step.next_step_class).to be LegalServices::RM3788::Journey::CheckSuitability
      end
    end
    ...
    context 'and the central government is no' do
      ...
      it 'returns Journey::SelectLot' do
        expect(step.next_step_class).to be LegalServices::RM3788::Journey::SelectLot
      end
    end
  end
