...
RSpec.describe LegalServices::RM3788::RegionalAvailability, type: :model do
  subject(:regional_availability) { build(:legal_services_rm3788_regional_availability) }
  ...
  it 'is not valid if availability exists for same region_code, supplier and service code' do
    ...
    new_availability = build(
      :legal_services_rm3788_regional_availability,
