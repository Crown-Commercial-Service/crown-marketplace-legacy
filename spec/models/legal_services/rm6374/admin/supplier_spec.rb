...
RSpec.describe LegalServices::RM6374::Admin::Supplier do
  let(:supplier) { create(:legal_services_rm6374_admin_supplier) }
  let(:existing_supplier) { create(:legal_services_rm6374_admin_supplier) }
