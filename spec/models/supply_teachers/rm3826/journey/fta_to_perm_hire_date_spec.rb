...
RSpec.describe SupplyTeachers::RM3826::Journey::FTAToPermHireDate, type: :model do
  subject(:step) do
    described_class.new(
    ...
    context 'when the contract hire date is within six months' do
      context 'when the contract length is less than 12 months' do
        ...
        it 'returns Journey::FTAToPermHireDateNotice' do
          expect(step.next_step_class).to be SupplyTeachers::RM3826::Journey::FTAToPermHireDateNotice
        end
      end
    end
