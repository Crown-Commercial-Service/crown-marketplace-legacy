...
RSpec.describe SupplyTeachers::RM3826::Journey::SchoolPostcodeAgencySuppliedWorker, type: :model do
  subject(:step) { described_class.new(postcode: postcode) }

  let(:model_key) { 'activemodel.errors.models.supply_teachers/rm3826/journey/school_postcode_agency_supplied_worker' }
