...
RSpec.describe SupplyTeachers::RM3826::Journey::PayrollProvider, type: :model do
  subject(:step) { described_class.new(payroll_provider: 'school') }

  let(:model_key) { 'activemodel.errors.models.supply_teachers/rm3826/journey/payroll_provider' }
