...
RSpec.describe SupplyTeachers::RM3826::Journey::LookingFor, type: :model do
  subject(:step) { described_class.new(looking_for: 'worker') }

  let(:model_key) { 'activemodel.errors.models.supply_teachers/rm3826/journey/looking_for' }
