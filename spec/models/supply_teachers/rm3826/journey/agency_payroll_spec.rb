...
RSpec.describe SupplyTeachers::RM3826::Journey::AgencyPayroll, type: :model do
  subject(:step) do
    described_class.new(
      postcode: postcode,
      term: SupplyTeachers::RM3826::Term.all.first,
      job_type: SupplyTeachers::RM3826::JobType.roles.first
    )
  end

  let(:model_key) { 'activemodel.errors.models.supply_teachers/rm3826/journey/agency_payroll' }
