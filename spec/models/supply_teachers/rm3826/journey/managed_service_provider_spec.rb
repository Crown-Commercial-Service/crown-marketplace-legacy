...
RSpec.describe SupplyTeachers::RM3826::Journey::ManagedServiceProvider, type: :model do
  subject(:step) { described_class.new(managed_service_provider: 'master_vendor') }

  let(:model_key) { 'activemodel.errors.models.supply_teachers/rm3826/journey/managed_service_provider' }
