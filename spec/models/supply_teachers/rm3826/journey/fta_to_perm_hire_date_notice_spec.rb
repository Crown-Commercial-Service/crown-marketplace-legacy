...
RSpec.describe SupplyTeachers::RM3826::Journey::FTAToPermHireDateNotice, type: :model do
  ...
  describe '.next_step_class' do
    it 'returns Journey::FTAToPermFixedTermFee' do
      expect(step.next_step_class).to be SupplyTeachers::RM3826::Journey::FTAToPermFixedTermFee
    end
  end
