...
RSpec.describe SupplyTeachers::RM3826::Journey::WorkerType, type: :model do
  subject(:step) { described_class.new(worker_type: 'nominated') }

  let(:model_key) { 'activemodel.errors.models.supply_teachers/rm3826/journey/worker_type' }
