...
RSpec.describe SupplyTeachers::RM6376::Journey::FTAToPermHireDateNotice do
  ...
  describe '.next_step_class' do
    it 'returns Journey::FTAToPermFixedTermFee' do
      expect(step.next_step_class).to be SupplyTeachers::RM6376::Journey::FTAToPermFixedTermFee
    end
  end
