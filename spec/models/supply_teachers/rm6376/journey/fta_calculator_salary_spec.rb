...
RSpec.describe SupplyTeachers::RM6376::Journey::FTACalculatorSalary do
  ...
  describe '.next_step_class' do
    it 'returns Journey::SchoolPostcodeAgencySuppliedWorker' do
      expect(step.next_step_class).to be SupplyTeachers::RM6376::Journey::SchoolPostcodeAgencySuppliedWorker
    end
  end
