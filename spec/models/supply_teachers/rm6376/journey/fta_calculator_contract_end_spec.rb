...
RSpec.describe SupplyTeachers::RM6376::Journey::FTACalculatorContractEnd do
  subject(:step) do
    described_class.new(
  ...
  describe '.next_step_class' do
    it 'returns Journey::FTACalculatorSalary' do
      expect(step.next_step_class).to be SupplyTeachers::RM6376::Journey::FTACalculatorSalary
    end
  end
