...
RSpec.describe SupplyTeachers::RM6376::Journey::LookingFor do
  subject(:step) { described_class.new(looking_for:) }
  ...
  describe '.next_step_class' do
    context 'when looking for is all_suppliers' do
      ...
      it 'returns Journey::AllSuppliers' do
        expect(step.next_step_class).to be SupplyTeachers::RM6376::Journey::AllSuppliers
      end
    end
    ...
    context 'when looking for is worker' do
      ...
      it 'returns Journey::WorkerType' do
        expect(step.next_step_class).to be SupplyTeachers::RM6376::Journey::WorkerType
      end
    end
    ...
    context 'when looking for is managed_service_provider' do
      ...
      it 'returns Journey::ManagedServiceProvider' do
        expect(step.next_step_class).to be SupplyTeachers::RM6376::Journey::ManagedServiceProvider
      end
    end
    ...
    context 'when looking for is calculate_temp_to_perm_fee' do
      ...
      it 'returns Journey::TempToPermCalculator' do
        expect(step.next_step_class).to be SupplyTeachers::RM6376::Journey::TempToPermCalculator
      end
    end
    ...
    context 'when looking for is calculate_fta_to_perm_fee' do
      ...
      it 'returns Journey::FTAToPermContractStart' do
        expect(step.next_step_class).to be SupplyTeachers::RM6376::Journey::FTAToPermContractStart
      end
    end
  end
