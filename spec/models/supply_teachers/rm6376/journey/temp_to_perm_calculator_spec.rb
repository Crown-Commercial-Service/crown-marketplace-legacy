...
RSpec.describe SupplyTeachers::RM6376::Journey::TempToPermCalculator do
  subject(:step) do
    described_class.new(
  ...
  let(:model_key) { 'activemodel.errors.models.supply_teachers/rm6376/journey/temp_to_perm_calculator' }
  ...
  describe '#next_step_class' do
    it 'is Fee' do
      expect(step.next_step_class).to eq(SupplyTeachers::RM6376::Journey::TempToPermFee)
    end
  end
  ...
  describe '.next_step_class' do
    it 'returns Journey::TempToPermFee' do
      expect(step.next_step_class).to be SupplyTeachers::RM6376::Journey::TempToPermFee
    end
  end
