...
RSpec.describe SupplyTeachers::RM6376::Journey::WorkerType do
  subject(:step) { described_class.new(worker_type:) }
  ...
  describe '.next_step_class' do
    ...
    context 'and the worker type is nominated' do
      ...
      it 'returns Journey::SchoolPostcodeNominatedWorker' do
        expect(step.next_step_class).to be SupplyTeachers::RM6376::Journey::SchoolPostcodeNominatedWorker
      end
    end
  end
