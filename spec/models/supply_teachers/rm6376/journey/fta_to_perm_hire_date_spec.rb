...
RSpec.describe SupplyTeachers::RM6376::Journey::FTAToPermHireDate do
  subject(:step) do
    described_class.new(
  ...
  describe '.next_step_class' do
    context 'when the contract hire date is within six months' do
      context 'when the contract length is less than 12 months' do
        ...
        it 'returns Journey::FTAToPermHireDateNotice' do
          expect(step.next_step_class).to be SupplyTeachers::RM6376::Journey::FTAToPermHireDateNotice
        end
      end
    end
    ...
    context 'when the contract hire date is not within six months' do
      ...
      it 'returns Journey::FTAToPermFee' do
        expect(step.next_step_class).to be SupplyTeachers::RM6376::Journey::FTAToPermFee
      end
