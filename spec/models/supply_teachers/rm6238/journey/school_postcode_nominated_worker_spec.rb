...
RSpec.describe SupplyTeachers::RM6238::Journey::SchoolPostcodeNominatedWorker, type: :model do
  ...
  describe '.next_step_class' do
    pending 'returns Journey::NominatedWorkerResults' do
      expect(step.next_step_class).to be SupplyTeachers::RM6238::Journey::NominatedWorkerResults
    end
  end
  ...
  describe '.slug' do
    it 'returns school-postcode-nominated-worker' do
      expect(step.slug).to eq 'school-postcode-nominated-worker'
    end
  end

  describe '.template' do
    it 'returns journey/school_postcode_nominated_worker' do
      expect(step.template).to eq 'journey/school_postcode_nominated_worker'
    end
  end
