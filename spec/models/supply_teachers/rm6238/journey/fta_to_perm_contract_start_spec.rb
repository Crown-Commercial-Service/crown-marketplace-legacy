...
RSpec.describe SupplyTeachers::RM6238::Journey::FTAToPermContractStart, type: :model do
  subject(:step) do
    described_class.new(
  ...
  describe '.next_step_class' do
    it 'returns Journey::FTAToPermContractEnd' do
      expect(step.next_step_class).to be SupplyTeachers::RM6238::Journey::FTAToPermContractEnd
    end
  end
