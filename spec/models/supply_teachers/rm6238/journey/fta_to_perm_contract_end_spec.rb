...
RSpec.describe SupplyTeachers::RM6238::Journey::FTAToPermContractEnd, type: :model do
  subject(:step) do
    described_class.new(
    ...
    context 'when the contract end date is within six months' do
      context 'when the contract length is less than 12 months' do
        ...
        it 'returns Journey::FTACalculatorSalary' do
          expect(step.next_step_class).to be SupplyTeachers::RM6238::Journey::FTAToPermHireDate
        end
      end
