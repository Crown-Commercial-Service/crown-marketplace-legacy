...
RSpec.describe SupplyTeachers::Journey, type: :model do
  ...
  context 'when following the school journey' do
    subject(:journey) do
      described_class.new('RM3826', slug, ActionController::Parameters.new(params))
    end
    ...
    context 'when on the Looking For page' do
      ...
      context 'with no parameters' do
        ...
        it { is_expected.to have_attributes(template: 'supply_teachers/rm3826/journey/looking_for') }
