...
RSpec.describe ManagementConsultancy::RM6309::Admin::Upload do
  ...
  describe 'aasm_state' do
    ...
    context 'when start_upload is called' do
      ...
      it 'starts the worker' do
        expect(ManagementConsultancy::RM6309::Admin::FileUploadWorker).to have_received(:perform_async).with(upload.id)
      end
    end
