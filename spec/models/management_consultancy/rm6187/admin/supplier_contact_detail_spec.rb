...
RSpec.describe ManagementConsultancy::RM6187::Admin::SupplierContactDetail do
  let(:contact_detail) { create(:management_consultancy_rm6187_admin_supplier_contact_detail) }
