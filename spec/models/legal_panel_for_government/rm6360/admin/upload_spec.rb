...
RSpec.describe LegalPanelForGovernment::RM6360::Admin::Upload do
    ...
    context 'when considering if the files are attached' do
      context 'and no files are attached' do
        it 'is not valid and has the correct error messages' do
          ...
          expect(upload.errors.messages.values.flatten).to match ["Select the 'Supplier details' file", "Select the 'Supplier service offerings' file", "Select the 'Supplier rate cards (lots 1, 2, 3, 5)' file", "Select the 'Supplier lot 4a rate cards' file", "Select the 'Supplier lot 4b rate cards' file", "Select the 'Supplier lot 4c rate cards' file"]
        end
      end

      context 'and four files are attached' do
        before do
          upload.supplier_other_lots_rate_cards_file = valid_file_path
          upload.supplier_lot_4a_rate_cards_file = valid_file_path
          upload.supplier_lot_4b_rate_cards_file = valid_file_path
          upload.supplier_lot_4c_rate_cards_file = valid_file_path
        end

        it 'is not valid and has the correct error messages' do
          expect(upload.valid?(:upload)).to be false
          expect(upload.errors.messages.values.flatten).to match ["Select the 'Supplier details' file", "Select the 'Supplier service offerings' file"]
        end
      end
    end
    ...
    context 'when considering the file extension' do
      context 'and no files have the correct file extension' do
        before do
          ...
          upload.supplier_service_offerings_file = text_file_path
          upload.supplier_other_lots_rate_cards_file = text_file_path
          upload.supplier_lot_4a_rate_cards_file = text_file_path
          upload.supplier_lot_4b_rate_cards_file = text_file_path
          upload.supplier_lot_4c_rate_cards_file = text_file_path
        end

        it 'is not valid and has the correct error messages' do
          expect(upload.valid?(:upload)).to be false
          expect(upload.errors.messages.values.flatten).to match ["The 'Supplier details' file must be an XLSX", "The 'Supplier service offerings' file must be an XLSX", "The 'Supplier rate cards (lots 1, 2, 3, 5)' file must be an XLSX", "The 'Supplier lot 4a rate cards' file must be an XLSX", "The 'Supplier lot 4b rate cards' file must be an XLSX", "The 'Supplier lot 4c rate cards' file must be an XLSX"]
        end
      end
      ...
      context 'and three files have the correct file extension' do
        ...
        it 'is not valid and has the correct error messages' do
          expect(upload.valid?(:upload)).to be false
          expect(upload.errors.messages.values.flatten).to match ["The 'Supplier service offerings' file must be an XLSX", "The 'Supplier lot 4a rate cards' file must be an XLSX", "The 'Supplier lot 4c rate cards' file must be an XLSX"]
        end
      end
    end
    ...
    context 'when considering the file content type' do
      context 'and no files have the correct content type' do
        before do
          ...
          upload.supplier_service_offerings_file = invalid_file_path
          upload.supplier_other_lots_rate_cards_file = invalid_file_path
          upload.supplier_lot_4a_rate_cards_file = invalid_file_path
          upload.supplier_lot_4b_rate_cards_file = invalid_file_path
          upload.supplier_lot_4c_rate_cards_file = invalid_file_path
        end

        it 'is not valid and has the correct error messages' do
          expect(upload.valid?(:upload)).to be false
          expect(upload.errors.messages.values.flatten).to match ["The 'Supplier details' file does not contain the expected content type", "The 'Supplier service offerings' file does not contain the expected content type", "The 'Supplier rate cards (lots 1, 2, 3, 5)' file does not contain the expected content type", "The 'Supplier lot 4a rate cards' file does not contain the expected content type", "The 'Supplier lot 4b rate cards' file does not contain the expected content type", "The 'Supplier lot 4c rate cards' file does not contain the expected content type"]
        end
      end
      ...
      context 'and three files have the correct content type' do
        before do
          upload.supplier_details_file = invalid_file_path
          upload.supplier_service_offerings_file = valid_file_path
          upload.supplier_other_lots_rate_cards_file = invalid_file_path
          upload.supplier_lot_4a_rate_cards_file = valid_file_path
          upload.supplier_lot_4b_rate_cards_file = invalid_file_path
          upload.supplier_lot_4c_rate_cards_file = valid_file_path
        ...
        it 'is not valid and has the correct error messages' do
          expect(upload.valid?(:upload)).to be false
          expect(upload.errors.messages.values.flatten).to match ["The 'Supplier details' file does not contain the expected content type", "The 'Supplier rate cards (lots 1, 2, 3, 5)' file does not contain the expected content type", "The 'Supplier lot 4b rate cards' file does not contain the expected content type"]
        end
      end
    end
  ...
  describe 'aasm_state' do
    ...
    context 'when start_upload is called' do
      ...
      it 'starts the worker' do
        expect(LegalPanelForGovernment::RM6360::Admin::FileUploadWorker).to have_received(:perform_async).with(upload.id)
      end
    end
