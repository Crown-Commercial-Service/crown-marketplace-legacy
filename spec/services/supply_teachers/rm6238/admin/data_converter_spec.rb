                ...
                supplier_framework_lots: [
                  { lot_id: 'RM6238.1',
                    ...
                    supplier_framework_lot_rates: [
                      ...
                      { position_id: 42, rate: 2483 },
                      { position_id: 47, rate: 2358 },
                      { position_id: 43, rate: 3034 },
                      { position_id: 48, rate: 2882 },
                      { position_id: 44, rate: 2621 },
                      { position_id: 49, rate: 2489 },
                      { position_id: 38, rate: 100 },
                      { position_id: 39, rate: 2207 },
                      { position_id: 40, rate: 1655 }
                    ],
                ...
                supplier_framework_lots: [
                  {
                    ...
                    supplier_framework_lot_rates: [
                      ...
                      { position_id: 42, rate: 2727 },
                      { position_id: 47, rate: 2590 },
                      { position_id: 43, rate: 3333 },
                      { position_id: 48, rate: 3166 },
                      { position_id: 44, rate: 2878 },
                      { position_id: 49, rate: 2734 },
                      { position_id: 38, rate: 0 },
                      { position_id: 39, rate: 2424 },
                      { position_id: 40, rate: 1818 }
                    ],
                    supplier_framework_lot_branches: []
                  },
                  {
                    ...
                    supplier_framework_lot_rates: [
                      ...
                      { position_id: 42, rate: 5144 },
                      { position_id: 47, rate: 4886 },
                      { position_id: 43, rate: 6287 },
                      { position_id: 48, rate: 5972 },
                      { position_id: 44, rate: 5430 },
                      { position_id: 49, rate: 5158 },
                      { position_id: 38, rate: 600 },
                      { position_id: 39, rate: 4572 },
                      { position_id: 40, rate: 3429 }
                    ],
                    supplier_framework_lot_branches: []
                  }
                ]
                ...
                supplier_framework_lots: [
                  {
                    ...
                    supplier_framework_lot_rates: [
                      ...
                      { position_id: 39, rate: 1755 },
                      { position_id: 40, rate: 1300 }
                    ],
                    supplier_framework_lot_branches: []
                  }
                ]
