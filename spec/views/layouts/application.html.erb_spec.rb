...
RSpec.describe 'layouts/application.html.erb' do
  let(:support_link_feedback_address) { 'https://www.smartsurvey.co.uk/s/MIIJB/' }
  ...
  before do
    ...
    allow(Marketplace).to receive_messages(google_analytics_tracking_id: '123', google_tag_manager_tracking_id: '456', mc_survey_link: support_link_feedback_address)
  end
