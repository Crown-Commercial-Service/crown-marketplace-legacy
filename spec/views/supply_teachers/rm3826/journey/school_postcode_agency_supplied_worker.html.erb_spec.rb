...
RSpec.describe 'supply_teachers/rm3826/journey/school_postcode_agency_supplied_worker.html.erb' do
  let(:step) { SupplyTeachers::RM3826::Journey::SchoolPostcodeAgencySuppliedWorker.new }
