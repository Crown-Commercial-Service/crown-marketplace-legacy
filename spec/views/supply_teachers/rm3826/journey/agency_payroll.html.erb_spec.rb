...
RSpec.describe 'supply_teachers/rm3826/journey/agency_payroll.html.erb' do
  let(:step) { SupplyTeachers::RM3826::Journey::AgencyPayroll.new }
  ...
  before do
    ...
    view.extend(SupplyTeachers::JourneyHelper)
