...
RSpec.describe ManagementConsultancy::RM6187::Admin::SuppliersController do
  ...
  let(:supplier) { create(:management_consultancy_rm6187_admin_supplier, sme: true) }
  let(:supplier_framework) { create(:supplier_framework, framework_id: 'RM6187', supplier_id: supplier.id) }
  let(:contact_detail) { create(:management_consultancy_rm6187_admin_supplier_contact_detail, supplier_framework_id: supplier_framework.id) }
  ...
  describe 'GET edit' do
    ...
    context 'when the section is unexpected' do
      ...
      it 'redirects to the show page' do
        expect(response).to redirect_to("/management-consultancy/RM6187/admin/suppliers/#{supplier_framework.id}")
      end
    end
  end
  ...
  describe 'PUT update' do
    ...
    context 'when the section is supplier_contact_information' do
      ...
      let(:change_data_after) { { 'name' => 'Zote the Mighty', 'email' => 'zote@the.mighty', 'telephone_number' => '07123456789', 'website' => 'https://example.com', } }
    ...
    context 'when the section is additional_supplier_information' do
      ...
      let(:change_data_after) { { 'additional_details' => { 'address' => 'Hollow nest' } } }
