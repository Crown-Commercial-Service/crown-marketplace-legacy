...
RSpec.describe ManagementConsultancy::RM6187::Admin::FrameworksController do
  ...
  describe 'POST update' do
    ...
    context 'when the data is valid' do
      it 'redirects to management_consultancy_rm6187_admin_frameworks_path' do
        expect(response).to redirect_to management_consultancy_rm6187_admin_frameworks_path
      end
    end
