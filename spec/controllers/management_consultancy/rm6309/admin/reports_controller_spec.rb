...
RSpec.describe ManagementConsultancy::RM6309::Admin::ReportsController do
  ...
  describe 'POST create' do
    ...
    context 'when the upload is valid' do
      ...
      it 'redirects to the show page' do
        expect(response).to redirect_to management_consultancy_rm6309_admin_report_path(report)
      end
