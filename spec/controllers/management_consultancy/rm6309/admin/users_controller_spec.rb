...
RSpec.describe ManagementConsultancy::RM6309::Admin::UsersController do
        ...
        context 'and it is valid' do
          context 'and there is an additional challange' do
            ...
            it 'redirects to management_consultancy_rm6309_admin_users_challenge_path' do
              expect(response).to redirect_to management_consultancy_rm6309_admin_users_challenge_path(challenge_name: new_challenge_name)
            end
