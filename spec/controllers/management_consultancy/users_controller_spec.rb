...
RSpec.describe ManagementConsultancy::UsersController, type: :controller do
  ...
  describe 'POST resend_confirmation_email' do
    ...
    it 'redirects to management_consultancy_users_confirm_path' do
      expect(response).to redirect_to management_consultancy_users_confirm_path
    end
  end
  ...
  describe 'GET challenge_new' do
    ...
    context 'when the challenge is NEW_PASSWORD_REQUIRED' do
      ...
      it 'renders the new_password_required partial' do
        expect(response).to render_template('management_consultancy/users/_new_password_required')
      end
    end
    ...
    context 'when the challenge is SMS_MFA' do
      ...
      it 'renders the sms_mfa partial' do
        expect(response).to render_template('management_consultancy/users/_sms_mfa')
      end
    end
  end
    ...
    context 'when the challenge is NEW_PASSWORD_REQUIRED' do
      ...
      context 'and it is valid' do
        context 'and there is an additional challange' do
          ...
          it 'redirects to management_consultancy_users_challenge_path' do
            expect(response).to redirect_to management_consultancy_users_challenge_path(challenge_name: new_challenge_name)
          end
