...
RSpec.describe ManagementConsultancy::Admin::UsersController, type: :controller do
  ...
  describe 'GET challenge_new' do
    ...
    context 'when the challenge is NEW_PASSWORD_REQUIRED' do
      ...
      it 'renders the new_password_required partial' do
        expect(response).to render_template('management_consultancy/admin/users/_new_password_required')
      end
    end
    ...
    context 'when the challenge is SMS_MFA' do
      ...
      it 'renders the sms_mfa partial' do
        expect(response).to render_template('management_consultancy/admin/users/_sms_mfa')
      end
    end
  end
    ...
    context 'when the challenge is NEW_PASSWORD_REQUIRED' do
      ...
      context 'and it is valid' do
        context 'and there is an additional challange' do
          ...
          it 'redirects to management_consultancy_admin_users_challenge_path' do
            expect(response).to redirect_to management_consultancy_admin_users_challenge_path(challenge_name: new_challenge_name)
          end
        ...
        context 'and there is no additional challange' do
          it 'redirects to management_consultancy_admin_uploads_path' do
            expect(response).to redirect_to management_consultancy_admin_uploads_path
          end
