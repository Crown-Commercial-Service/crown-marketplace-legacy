...
RSpec.describe ManagementConsultancy::Admin::PasswordsController, type: :controller do
  ...
  describe 'POST create' do
    ...
    context 'when the email is invalid' do
      ...
      it 'redirects to the management_consultancy_admin_new_user_password_path' do
        expect(response).to redirect_to management_consultancy_admin_new_user_password_path
      end
    ...
    context 'when the email is valid' do
      ...
      it 'redirects to management_consultancy_admin_edit_user_password_path' do
        expect(response).to redirect_to management_consultancy_admin_edit_user_password_path
      end
  ...
  describe 'PUT update' do
    ...
    context 'when the reset password is valid' do
      ...
      it 'redirects to management_consultancy_admin_password_reset_success_path' do
        expect(response).to redirect_to management_consultancy_admin_password_reset_success_path
      end
