...
RSpec.describe ManagementConsultancy::Admin::SessionsController, type: :controller do
    ...
    context 'when the login attempt is successful' do
      ...
      context 'and there is a challenge' do
        ...
        it 'redirects to management_consultancy_admin_users_challenge_path' do
          expect(response).to redirect_to management_consultancy_admin_users_challenge_path(challenge_name: challenge_name)
        end
