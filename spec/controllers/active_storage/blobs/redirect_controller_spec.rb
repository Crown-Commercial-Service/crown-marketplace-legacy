...
RSpec.describe ActiveStorage::Blobs::RedirectController do
  ...
  describe '#show' do
    ...
    context 'when trying to download a supply teachers document in RM6376' do
      ...
      let(:blob_object_id_key) { :st_rm6376_upload_id }
      let(:blob_object_id) { admin_upload.id }
      let(:admin_upload) { create(:supply_teachers_rm6376_admin_upload_with_document) }
    ...
    context 'when trying to download a legal services document in RM6374' do
      let(:signed_id) { admin_upload.supplier_details_file.blob.signed_id }
      let(:filename) { admin_upload.supplier_details_file.blob.filename }
      let(:blob_object_id_key) { :ls_rm6374_upload_id }
      let(:blob_object_id) { admin_upload.id }
      let(:admin_upload) { create(:legal_services_rm6374_admin_upload_with_document) }
