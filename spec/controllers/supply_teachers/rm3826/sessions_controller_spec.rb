...
RSpec.describe SupplyTeachers::RM3826::SessionsController, type: :controller do
  ...
  describe 'POST create' do
    ...
    context 'when the log in attempt is unsuccessful' do
      ...
      context 'when the user needs confirmation' do
        ...
        it 'redirects to supply_teachers_rm3826_edit_user_password_path' do
          expect(response).to redirect_to supply_teachers_rm3826_users_confirm_path
        end
    ...
    context 'when the login attempt is successful' do
      ...
      context 'and there is a challenge' do
        ...
        it 'redirects to supply_teachers_rm3826_users_challenge_path' do
          expect(response).to redirect_to supply_teachers_rm3826_users_challenge_path(challenge_name: challenge_name)
        end
