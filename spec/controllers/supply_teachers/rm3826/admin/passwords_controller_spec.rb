...
RSpec.describe SupplyTeachers::RM3826::Admin::PasswordsController, type: :controller do
  ...
  describe 'POST create' do
    context 'when no exception is raised' do
      ...
      context 'when the email is invalid' do
        ...
        it 'redirects to the supply_teachers_rm3826_admin_new_user_password_path' do
          expect(response).to redirect_to supply_teachers_rm3826_admin_new_user_password_path
        end
  ...
  describe 'PUT update' do
    ...
    context 'when the reset password is valid' do
      ...
      it 'redirects to supply_teachers_rm3826_admin_password_reset_success_path' do
        expect(response).to redirect_to supply_teachers_rm3826_admin_password_reset_success_path
      end
