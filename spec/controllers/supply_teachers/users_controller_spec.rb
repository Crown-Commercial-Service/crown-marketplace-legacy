...
RSpec.describe SupplyTeachers::UsersController, type: :controller do
  ...
  describe 'GET challenge_new' do
    ...
    context 'when the challenge is NEW_PASSWORD_REQUIRED' do
      ...
      it 'renders the new_password_required partial' do
        expect(response).to render_template('supply_teachers/users/_new_password_required')
      end
    end
    ...
    context 'when the challenge is SMS_MFA' do
      ...
      it 'renders the sms_mfa partial' do
        expect(response).to render_template('supply_teachers/users/_sms_mfa')
      end
    end
  end
      ...
      context 'and it is valid' do
        context 'and there is an additional challange' do
          ...
          it 'redirects to supply_teachers_users_challenge_path' do
            expect(response).to redirect_to supply_teachers_users_challenge_path(challenge_name: new_challenge_name)
          end
