...
RSpec.describe SupplyTeachers::RM6376::Admin::UsersController do
        ...
        context 'and it is valid' do
          context 'and there is an additional challange' do
            ...
            it 'redirects to supply_teachers_rm6376_admin_users_challenge_path' do
              expect(response).to redirect_to supply_teachers_rm6376_admin_users_challenge_path(challenge_name: new_challenge_name)
            end
