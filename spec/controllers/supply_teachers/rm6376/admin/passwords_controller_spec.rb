...
RSpec.describe SupplyTeachers::RM6376::Admin::PasswordsController do
  ...
  describe 'PUT update' do
    ...
    context 'when the framework is live' do
      ...
      context 'when the reset password is valid' do
        ...
        it 'redirects to supply_teachers_rm6376_admin_password_reset_success_path' do
          expect(response).to redirect_to supply_teachers_rm6376_admin_password_reset_success_path
        end
