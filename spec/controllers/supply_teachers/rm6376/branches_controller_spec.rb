...
RSpec.describe SupplyTeachers::RM6376::BranchesController do
  ...
  describe 'GET index' do
    ...
    context 'when not logged in' do
      it 'redirects to gateway page' do
        expect(get(:index)).to redirect_to(supply_teachers_rm6376_gateway_url)
      end
    end
    ...
    shared_context 'and the postcode is valid' do
      ...
      it 'responds to requests for spreadsheets' do
        allow(SupplyTeachers::Spreadsheet)
          .to receive(:new)
          .and_return(instance_double(SupplyTeachers::Spreadsheet, to_xlsx: 'spreadsheet-data'))
