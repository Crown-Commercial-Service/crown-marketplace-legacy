...
# do so in data/spec_templates/passwords_controller_spec.txt and the run:
# bundle exec rake generate_authentication_specs

require 'rails_helper'

RSpec.describe SupplyTeachers::RM6376::PasswordsController do
  ...
  describe 'PUT update' do
    ...
    context 'when the framework is live' do
      ...
      context 'when the reset password is valid' do
        ...
        it 'redirects to supply_teachers_rm6376_password_reset_success_path' do
          expect(response).to redirect_to supply_teachers_rm6376_password_reset_success_path
        end
