...
RSpec.describe SupplyTeachers::RM6376::SuppliersController do
  ...
  describe 'GET managed_service_providerss' do
    ...
    before do
      ...
      get :managed_service_providerss, params: {
        looking_for: 'managed_service_providers'
      }
    end

    it 'renders the managed_service_providerss template' do
      expect(response).to render_template('managed_service_providerss')
    end
