...
RSpec.describe SupplyTeachers::RM6238::Admin::ChangeLogsController do
  ...
  describe 'GET index CSV' do
    ...
    it 'download the csv' do
      expect(response.headers['Content-Disposition']).to include 'filename="Change log - Supply Teachers - RM6238 - '
