...
RSpec.describe SupplyTeachers::RM6238::Admin::UsersController, type: :controller do
  ...
  describe 'GET challenge_new' do
    ...
    context 'when the challenge is NEW_PASSWORD_REQUIRED' do
      ...
      it 'renders the new_password_required partial' do
        expect(response).to render_template('supply_teachers/rm6238/admin/users/_new_password_required')
      end
    end
    ...
    context 'when the challenge is SMS_MFA' do
      ...
      it 'renders the sms_mfa partial' do
        expect(response).to render_template('supply_teachers/rm6238/admin/users/_sms_mfa')
      end
    end
  end
