...
RSpec.describe SupplyTeachers::RM6238::Admin::FrameworksController do
  ...
  describe 'POST update' do
    ...
    context 'when the data is valid' do
      it 'redirects to supply_teachers_rm6238_admin_frameworks_path' do
        expect(response).to redirect_to supply_teachers_rm6238_admin_frameworks_path
      end
    end
