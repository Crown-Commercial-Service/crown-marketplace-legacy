...
RSpec.describe LegalServices::RM6240::Admin::LotDataController do
  ...
  let(:supplier_framework_lot_jurisdiction) { create(:supplier_framework_lot_jurisdiction, supplier_framework_lot: supplier_framework_lot, jurisdiction_id: 'RM6240.GB') }
  let(:lot_number) { '1a' }
      ...
      context 'and the section is services' do
        ...
        context 'when it is valid' do
          ...
          it 'creates a change log' do
            ...
            expect(change_log.change_data['id']).to eq(supplier_framework_lot.id)
            expect(change_log.change_data['added']).to eq(['RM6240.1a.6', 'RM6240.1a.7'])
            expect(change_log.change_data['removed']).to eq(['RM6240.1a.4', 'RM6240.1a.5'])
          end
      ...
      context 'and the section is rates' do
        ...
        context 'when it is valid' do
          ...
          it 'creates a change log' do
            ...
            expect(change_log.change_data['id']).to eq(supplier_framework_lot.id)
            expect(change_log.change_data['jurisdiction_id']).to eq('RM6240.GB')
            expect(change_log.change_data['rates'].map { |rate_change| { position_id: rate_change['position_id'], before_rate: rate_change['before'].present?, after: rate_change['after'] } }).to eq(
              [
                { after: 234567, before_rate: true, position_id: 'RM6240.1a.1' },
                { after: 234567, before_rate: true, position_id: 'RM6240.1a.2' },
                { after: 234567, before_rate: true, position_id: 'RM6240.1a.3' },
                { after: 234567, before_rate: true, position_id: 'RM6240.1a.4' },
                { after: 234567, before_rate: true, position_id: 'RM6240.1a.5' },
                { after: 234567, before_rate: true, position_id: 'RM6240.1a.6' },
                { after: 234567, before_rate: false, position_id: 'RM6240.1a.7' }
              ]
            )
          end
      ...
      context 'and the section is services' do
        ...
        context 'when it is valid' do
          ...
          it 'creates a change log' do
            ...
            expect(change_log.change_data['removed']).to eq(['RM6240.3.1'])
          end
          # rubocop:enable RSpec/MultipleExpectations
        end
      ...
      context 'and the section is rates' do
        ...
        context 'when it is valid' do
          ...
          it 'creates a change log' do
            ...
            expect(change_log.change_data['rates'].map { |rate_change| { position_id: rate_change['position_id'], before_rate: rate_change['before'].present?, after: rate_change['after'] } }).to eq(
              [
                { after: 234567, before_rate: true, position_id: 'RM6240.3.1' },
                { after: 234567, before_rate: true, position_id: 'RM6240.3.2' },
                { after: 234567, before_rate: true, position_id: 'RM6240.3.3' },
                { after: 234567, before_rate: true, position_id: 'RM6240.3.4' },
                { after: 234567, before_rate: true, position_id: 'RM6240.3.5' },
                { after: 234567, before_rate: true, position_id: 'RM6240.3.6' }
              ]
            )
          end
          # rubocop:enable RSpec/MultipleExpectations, RSpec/ExampleLength
