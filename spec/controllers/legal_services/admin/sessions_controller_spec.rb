...
RSpec.describe LegalServices::Admin::SessionsController, type: :controller do
  ...
  describe 'POST create' do
    ...
    context 'when the log in attempt is unsuccessful' do
      ...
      context 'when the password needs to be reset' do
        ...
        it 'redirects to legal_services_admin_edit_user_password_path' do
          expect(response).to redirect_to legal_services_admin_edit_user_password_path
        end
    ...
    context 'when the login attempt is successful' do
      ...
      let(:cognito_groups) do
        OpenStruct.new(groups: [
                         ...
                         OpenStruct.new(group_name: 'ls_access')
                       ])
      end
      ...
      context 'and there is no challenge' do
        ...
        it 'redirects to legal_services_admin_uploads_path' do
          expect(response).to redirect_to legal_services_admin_uploads_path
        end
      end
      ...
      context 'and there is a challenge' do
        ...
        it 'redirects to legal_services_admin_users_challenge_path' do
          expect(response).to redirect_to legal_services_admin_users_challenge_path(challenge_name: challenge_name)
        end
