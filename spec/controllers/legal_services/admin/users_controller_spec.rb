...
RSpec.describe LegalServices::Admin::UsersController, type: :controller do
  ...
  describe 'GET challenge_new' do
    ...
    context 'when the challenge is NEW_PASSWORD_REQUIRED' do
      ...
      it 'renders the new_password_required partial' do
        expect(response).to render_template('legal_services/admin/users/_new_password_required')
      end
    end
    ...
    context 'when the challenge is SMS_MFA' do
      ...
      it 'renders the sms_mfa partial' do
        expect(response).to render_template('legal_services/admin/users/_sms_mfa')
      end
    end
  end
      ...
      context 'and it is valid' do
        context 'and there is an additional challange' do
          ...
          it 'redirects to legal_services_admin_users_challenge_path' do
            expect(response).to redirect_to legal_services_admin_users_challenge_path(challenge_name: new_challenge_name)
          end
