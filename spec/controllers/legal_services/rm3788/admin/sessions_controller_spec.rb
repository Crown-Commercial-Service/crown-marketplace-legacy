...
RSpec.describe LegalServices::RM3788::Admin::SessionsController, type: :controller do
    ...
    context 'when the log in attempt is unsuccessful' do
      ...
      context 'when the password needs to be reset' do
        ...
        it 'redirects to legal_services_rm3788_admin_edit_user_password_path' do
          expect(response).to redirect_to legal_services_rm3788_admin_edit_user_password_path
        end
    ...
    context 'when the login attempt is successful' do
      ...
      context 'and there is a challenge' do
        ...
        it 'redirects to legal_services_rm3788_admin_users_challenge_path' do
          expect(response).to redirect_to legal_services_rm3788_admin_users_challenge_path(challenge_name: challenge_name)
        end
