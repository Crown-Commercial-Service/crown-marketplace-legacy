...
RSpec.describe LegalServices::RM3788::Admin::PasswordsController, type: :controller do
  ...
  describe 'POST create' do
    context 'when no exception is raised' do
      ...
      context 'when the email is invalid' do
        ...
        it 'redirects to the legal_services_rm3788_admin_new_user_password_path' do
          expect(response).to redirect_to legal_services_rm3788_admin_new_user_password_path
        end
  ...
  describe 'PUT update' do
    ...
    context 'when the reset password is valid' do
      ...
      it 'redirects to legal_services_rm3788_admin_password_reset_success_path' do
        expect(response).to redirect_to legal_services_rm3788_admin_password_reset_success_path
      end
