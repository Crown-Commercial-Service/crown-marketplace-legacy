...
# do so in data/spec_templates/sessions_controller_spec.txt and the run:
# bundle exec rake generate_authentication_specs

require 'rails_helper'

RSpec.describe LegalServices::RM6374::SessionsController do
  ...
  describe 'GET new' do
    ...
    context 'when the framework is not live' do
      include_context 'and RM6374 has expired'
  ...
  describe 'POST create' do
    ...
    context 'when the log in attempt is unsuccessful' do
      ...
      context 'when the password needs to be reset' do
        ...
        it 'redirects to legal_services_rm6374_edit_user_password_path' do
          expect(response).to redirect_to legal_services_rm6374_edit_user_password_path
        end
      ...
      context 'when the user needs confirmation' do
        ...
        it 'redirects to legal_services_rm6374_edit_user_password_path' do
          expect(response).to redirect_to legal_services_rm6374_users_confirm_path
        end
    ...
    context 'when the login attempt is successful' do
      ...
      context 'and there is no challenge' do
        ...
        it 'redirects to legal_services_rm6374_buyer_details_path' do
          expect(response).to redirect_to legal_services_rm6374_buyer_details_path
        end
      end
      ...
      context 'and there is a challenge' do
        ...
        it 'redirects to legal_services_rm6374_users_challenge_path' do
          expect(response).to redirect_to legal_services_rm6374_users_challenge_path(challenge_name:)
        end
