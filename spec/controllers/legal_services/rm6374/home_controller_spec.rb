...
RSpec.describe LegalServices::RM6374::HomeController do
  let(:default_params) { { service: 'legal_services', framework: 'RM6374' } }
  ...
  describe 'GET index' do
    ...
    context 'when the user is logged in' do
      it 'redirects to the buyer details page' do
        ...
        expect(response).to redirect_to('/legal-services/RM6374/buyer-details')
      end
    end
  end
