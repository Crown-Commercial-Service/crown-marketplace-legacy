...
RSpec.describe LegalServices::RM6374::PasswordsController do
  ...
  describe 'PUT update' do
    ...
    context 'when the framework is live' do
      ...
      context 'when the reset password is valid' do
        ...
        it 'redirects to legal_services_rm6374_password_reset_success_path' do
          expect(response).to redirect_to legal_services_rm6374_password_reset_success_path
        end
