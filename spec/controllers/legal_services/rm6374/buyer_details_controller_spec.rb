...
RSpec.describe LegalServices::RM6374::BuyerDetailsController do
  ...
  describe 'GET index' do
    ...
    context 'when logged in without buyer details' do
      ...
      it 'redirects to the edit page' do
        expect(response).to redirect_to("/legal-services/RM6374/buyer-details/#{user.buyer_detail.id}")
      end
    end
    ...
    context 'when the framework is not recognised' do
      ...
      it 'sets the framework variables' do
        ...
        expect(controller.params[:framework]).to eq Framework.legal_services.current_framework
      end
    end
  end
