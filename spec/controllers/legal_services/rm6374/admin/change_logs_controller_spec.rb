...
RSpec.describe LegalServices::RM6374::Admin::ChangeLogsController do
  let(:framework_id) { 'RM6374' }
  ...
  describe 'GET index CSV' do
    ...
    it 'download the csv' do
      expect(response.headers['Content-Disposition']).to include 'filename="Change log - Legal Services - RM6374 - '
