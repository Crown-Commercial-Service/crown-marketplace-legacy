...
RSpec.describe LegalServices::RM6374::Admin::FrameworksController do
  ...
  describe 'POST update' do
    ...
    context 'when the data is valid' do
      it 'redirects to legal_services_rm6374_admin_frameworks_path' do
        expect(response).to redirect_to legal_services_rm6374_admin_frameworks_path
      end
    end
