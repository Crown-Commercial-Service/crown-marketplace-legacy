...
RSpec.describe LegalServices::RM6374::Admin::SessionsController do
  ...
  describe 'POST create' do
    ...
    context 'when the log in attempt is unsuccessful' do
      ...
      context 'when the password needs to be reset' do
        ...
        it 'redirects to legal_services_rm6374_admin_edit_user_password_path' do
          expect(response).to redirect_to legal_services_rm6374_admin_edit_user_password_path
        end
      ...
      context 'when the user needs confirmation' do
        ...
        it 'redirects to legal_services_rm6374_admin_edit_user_password_path' do
          expect(response).to redirect_to legal_services_rm6374_admin_users_confirm_path
        end
    ...
    context 'when the login attempt is successful' do
      ...
      context 'and there is no challenge' do
        ...
        it 'redirects to legal_services_rm6374_admin_path' do
          expect(response).to redirect_to legal_services_rm6374_admin_path
        end
      end
      ...
      context 'and there is a challenge' do
        ...
        it 'redirects to legal_services_rm6374_admin_users_challenge_path' do
          expect(response).to redirect_to legal_services_rm6374_admin_users_challenge_path(challenge_name:)
        end
