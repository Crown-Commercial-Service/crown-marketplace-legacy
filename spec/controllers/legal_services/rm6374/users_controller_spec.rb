...
# do so in data/spec_templates/users_controller_spec.txt and the run:
# bundle exec rake generate_authentication_specs

require 'rails_helper'

RSpec.describe LegalServices::RM6374::UsersController do
  ...
  describe 'POST resend_confirmation_email' do
    ...
    context 'when the framework is live' do
      ...
      it 'redirects to legal_services_rm6374_users_confirm_path' do
        ...
        context 'and it is valid' do
          context 'and there is an additional challange' do
            ...
            it 'redirects to legal_services_rm6374_users_challenge_path' do
              expect(response).to redirect_to legal_services_rm6374_users_challenge_path(challenge_name: new_challenge_name)
            end
