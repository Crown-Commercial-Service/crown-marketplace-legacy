...
RSpec.describe LegalServices::RegistrationsController, type: :controller do
  ...
  describe 'POST create' do
    ...
    context 'when the emaildomain is not on the allow list' do
      ...
      it 'redirects to legal_services_domain_not_on_safelist_path' do
        expect(response).to redirect_to legal_services_domain_not_on_safelist_path
      end
    end
