...
RSpec.describe LegalPanelForGovernment::RM6360::PasswordsController do
  ...
  describe 'PUT update' do
    ...
    context 'when the framework is live' do
      ...
      context 'when the reset password is valid' do
        ...
        it 'redirects to legal_panel_for_government_rm6360_password_reset_success_path' do
          expect(response).to redirect_to legal_panel_for_government_rm6360_password_reset_success_path
        end
