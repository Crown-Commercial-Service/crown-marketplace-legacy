...
RSpec.describe LegalPanelForGovernment::RM6360::RegistrationsController do
    ...
    context 'when the framework is live' do
      context 'when no exception is raised' do
        ...
        context 'when the emaildomain is not on the allow list' do
          ...
          it 'redirects to legal_panel_for_government_rm6360_domain_not_on_safelist_path' do
            expect(response).to redirect_to legal_panel_for_government_rm6360_domain_not_on_safelist_path
          end
        end
