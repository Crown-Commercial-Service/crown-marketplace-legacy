...
RSpec.describe LegalPanelForGovernment::RM6360::Admin::UsersController do
        ...
        context 'and it is valid' do
          context 'and there is an additional challange' do
            ...
            it 'redirects to legal_panel_for_government_rm6360_admin_users_challenge_path' do
              expect(response).to redirect_to legal_panel_for_government_rm6360_admin_users_challenge_path(challenge_name: new_challenge_name)
            end
