...
RSpec.describe LegalPanelForGovernment::RM6360::Admin::SuppliersController do
  ...
  let(:supplier) { create(:legal_panel_for_government_rm6360_admin_supplier, sme: true) }
  let(:supplier_framework) { create(:supplier_framework, framework_id: 'RM6360', supplier_id: supplier.id) }
  let(:contact_detail) { create(:legal_panel_for_government_rm6360_admin_supplier_contact_detail, supplier_framework_id: supplier_framework.id) }
  ...
  describe 'GET edit' do
    ...
    context 'when the section is additional_supplier_information' do
      ...
      let(:section_attributes) { %i[address lot_1_prospectus_link lot_2_prospectus_link lot_3_prospectus_link lot_4a_prospectus_link lot_4b_prospectus_link lot_4c_prospectus_link lot_5_prospectus_link] }
      let(:model) { contact_detail }
    ...
    context 'when the section is unexpected' do
      ...
      it 'redirects to the show page' do
        expect(response).to redirect_to("/legal-panel-for-government/RM6360/admin/suppliers/#{supplier_framework.id}")
      end
    end
  end
  ...
  describe 'PUT update' do
    ...
    context 'when the section is additional_supplier_information' do
      ...
      let(:model) { contact_detail }
      let(:model_params) { { address: 'Hollow nest', lot_1_prospectus_link: 'https://example.com', lot_2_prospectus_link: 'https://example.com', lot_3_prospectus_link: 'https://example.com', lot_4a_prospectus_link: 'https://example.com', lot_4b_prospectus_link: 'https://example.com', lot_4c_prospectus_link: 'https://example.com', lot_5_prospectus_link: 'https://example.com' } }
      let(:model_param_keys) { %i[additional_details] }
      let(:expected_updates) { { additional_details: model_params } }
      let(:model_params_invalid) { { address: '', lot_1_prospectus_link: '', lot_2_prospectus_link: '', lot_3_prospectus_link: '', lot_4a_prospectus_link: '', lot_4b_prospectus_link: '', lot_4c_prospectus_link: '', lot_5_prospectus_link: '' } }
