...
RSpec.describe LegalPanelForGovernment::Admin::FrameworksController do
  ...
  describe 'POST update' do
    ...
    context 'when the data is valid' do
      it 'redirects to legal_panel_for_government_admin_frameworks_path' do
        expect(response).to redirect_to legal_panel_for_government_admin_frameworks_path
      end
    end
