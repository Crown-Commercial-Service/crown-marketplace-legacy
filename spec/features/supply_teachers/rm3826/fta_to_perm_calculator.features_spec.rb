...
RSpec.feature 'FTA to Perm fee calculator', type: :feature, supply_teachers: true do
  ...
  scenario 'Worker contract end date is more than 6 months ago' do
    ...
    expect_fee_text I18n.t('.supply_teachers.rm3826.home.fta_to_perm_fee.no_fee.end_not_within_6_months')
  end
  ...
  scenario 'Worker contract end date is 6 months ago - 1 day' do
    ...
    expect_no_fee_text I18n.t('.supply_teachers.rm3826.home.fta_to_perm_fee.no_fee.end_not_within_6_months')
  end
  ...
  scenario 'Worker has been employed for 12 months or more' do
    ...
    expect_fee_text I18n.t('.supply_teachers.rm3826.home.fta_to_perm_fee.no_fee.length_not_within_12_months')
  end
  ...
  scenario 'Worker has been employed for 12 months - 2 days' do
    ...
    expect_no_fee_text I18n.t('.supply_teachers.rm3826.home.fta_to_perm_fee.no_fee.length_not_within_12_months')
  end
  ...
  scenario 'The gap between contract end date and hire date is grater than or equal to 6 months' do
    ...
    expect_fee_text I18n.t('.supply_teachers.rm3826.home.fta_to_perm_fee.no_fee.hire_not_within_6_months')
  end
  ...
  scenario 'The gap between contract end date and hire date is 6 months - 1.day' do
    ...
    expect_no_fee_text I18n.t('.supply_teachers.rm3826.home.fta_to_perm_fee.no_fee.hire_not_within_6_months')
  end
  ...
  scenario 'The gap between contract end date and hire date is less than 6 months' do
    ...
    expect_fee_text I18n.t('supply_teachers.rm3826.journey.fta_to_perm_hire_date_notice.header_html', date: date_1_month_from_now.strftime('%d %b %Y'))
  end
  ...
  scenario 'Worker contract end date is less than 6 months, has been employed for less than 12 months and hire date is less than 6 months' do
    ...
    fill_in_hire_date date_0_months_ago
    click_on I18n.t('common.submit')
    click_on I18n.t('supply_teachers.rm3826.journey.fta_to_perm_hire_date_notice.submit')
    fill_in 'fixed_term_fee', with: '12000'
    click_on I18n.t('common.submit')

    expect_fee_text "#{I18n.t('.supply_teachers.rm3826.home.fta_to_perm_fee.header')} #{number_to_currency(12000 / difference_in_months(date_13_months_ago, date_5_months_ago).to_f * 12 - 12000)}"
  end
  ...
  scenario 'Worker contract length is 5 months - 1.day, fixed term fee is 2500 and hire date is less than 6 months' do
    ...
    expect_fee_text "#{I18n.t('.supply_teachers.rm3826.home.fta_to_perm_fee.header')} #{number_to_currency(2500 / difference_in_months(date_6_months_ago, date_1_month_ago - 1.day) * 12 - 2500)}"
  end
  ...
  scenario 'Worker contract length is 5 + 1/2 months, fixed term fee is 2500 and hire date is less than 6 months' do
    ...
    expect_fee_text "#{I18n.t('.supply_teachers.rm3826.home.fta_to_perm_fee.header')} #{number_to_currency(2500 / difference_in_months(date_6_months_ago, date_1_month_ago - 12.days) * 12 - 2500)}"
  end
