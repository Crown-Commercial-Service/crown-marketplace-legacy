...
RSpec.feature 'Nominated workers', type: :feature, supply_teachers: true do
  ...
  scenario 'Buyer finds suppliers within search range' do
    holborn = create(:supply_teachers_rm3826_supplier, name: 'holborn')
    create(
      :supply_teachers_rm3826_rate,
      supplier: holborn,
      lot_number: 1,
      job_type: 'nominated',
      mark_up: 0.35
    ...
    westminster = create(:supply_teachers_rm3826_supplier, name: 'westminster')
    create(
      :supply_teachers_rm3826_rate,
    ...
    whitechapel = create(:supply_teachers_rm3826_supplier, name: 'whitechapel')
    create(
      :supply_teachers_rm3826_branch,
      supplier: whitechapel,
      location: Geocoding.point(latitude: 51.5106034, longitude: -0.0604652)
    )
    liverpool = create(:supply_teachers_rm3826_supplier, name: 'liverpool')
    create(
      :supply_teachers_rm3826_branch,
      supplier: liverpool,
