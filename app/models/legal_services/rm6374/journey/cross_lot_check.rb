  ...
  module RM6374
    class Journey::CrossLotCheck
      ...
      def self.evaluate(selected_sector:, selected_specialisms:)
        ...
        recommended_lot = selected_sector.nil? ? '2' : SECTOR_MAPPING[selected_sector]

        # get all the service numbers for lot_1
        lot_1_services = {
          '1a': get_service_numbers('1a'),
          '1b': get_service_numbers('1b'),
          '1c': get_service_numbers('1c'),
        }
        ...
        alternative_lots << '2' if lot_2_suppliers.present? && !selected_sector.nil?
