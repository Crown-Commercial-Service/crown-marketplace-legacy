  ...
  module RM6240
    module Admin
      class Upload < ::Admin::Upload
        ...
        ATTRIBUTES = %i[supplier_details_file supplier_rate_cards_file supplier_lot_1_service_offerings_file supplier_lot_2_service_offerings_file supplier_lot_3_service_offerings_file].freeze
      end
    end
  end
end
