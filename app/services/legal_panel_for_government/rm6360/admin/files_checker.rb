class LegalPanelForGovernment::RM6360::Admin::FilesChecker
  ...
  def check_supplier_lot_service_offerings_spreadsheet(service_offerings_workbook)
    check_sheets(service_offerings_workbook, SERVICE_OFFERING_SHEETS[:sheets], 'supplier_service_offerings_file') do |sheets_with_errors, empty_sheets, index|
  ...
  def check_suppliers_other_lots_rate_cards_file(rate_cards_workbook)
    check_sheets(rate_cards_workbook, OTHER_LOTS_RATE_CARD_SHEETS, 'supplier_other_lots_rate_cards_file') do |sheets_with_errors, empty_sheets, index|
  ...
  def check_suppliers_lot_4_rate_cards_file(rate_cards_workbook, lot_number)
    check_sheets(rate_cards_workbook, LOT_4_RATE_CARD_SHEETS, "supplier_lot_#{lot_number}_rate_cards_file") do |sheets_with_errors, empty_sheets, index|
