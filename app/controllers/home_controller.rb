class HomeController < ApplicationController
  before_action :authenticate_user!, except: %i[status index cookies landing_page accessibility_statement_mc accessibility_statement_ls accessibility_statement_st not_permitted]
