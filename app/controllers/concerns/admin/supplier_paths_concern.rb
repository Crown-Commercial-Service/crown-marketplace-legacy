module Admin::SupplierPathsConcern
  ...
  included do
    helper_method :suppliers_index_path, :supplier_show_path, :supplier_edit_path, :supplier_update_path, :supplier_lot_data_index_path, :supplier_lot_data_show_path, :supplier_lot_data_edit_path, :supplier_lot_data_update_path, :supplier_uploads_index_path, :supplier_uploads_show_path, :supplier_change_logs_index_path, :supplier_change_logs_show_path, :framework_show_path, :framework_edit_path, :framework_update_path
  end
