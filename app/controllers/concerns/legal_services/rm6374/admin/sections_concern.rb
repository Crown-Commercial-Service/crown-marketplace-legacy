module LegalServices::RM6374::Admin::SectionsConcern
  ...
  SECTION_TO_PARAMS = {
    ...
    customer_sector_selection: %i[health local_community_and_housing government_policy education defence_and_security infrastructure culture_media_and_sport]
  }.freeze
end
