    ...
    module Admin
      class UploadsController < SupplyTeachers::Admin::FrameworkController
        ...
        def create
          ...
          if @upload.save
            @upload.start_upload!
            redirect_to supply_teachers_rm3826_admin_upload_path(id: @upload.id)
          else
            render :new
          end
        end
        ...
        def update
          ...
          redirect_to supply_teachers_rm3826_admin_upload_path
        end

        def destroy
          @upload.destroy
          redirect_to supply_teachers_rm3826_admin_uploads_path
        end
        ...
        def upload_params
          params.require(:supply_teachers_rm3826_admin_upload).permit(:current_accredited_suppliers, :geographical_data_all_suppliers, :lot_1_and_lot_2_comparisons, :master_vendor_contacts, :neutral_vendor_contacts, :pricing_for_tool, :supplier_lookup) if params[:supply_teachers_rm3826_admin_upload].present?
        end
